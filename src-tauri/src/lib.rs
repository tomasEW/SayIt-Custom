...
const DEFAULT_SENTRY_RELEASE: &str = concat!("sayit-custom@", env!("CARGO_PKG_VERSION"));
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let quit_item =
                MenuItem::with_id(app, "quit", "Quit SayIt Custom", true, None::<&str>)?;
